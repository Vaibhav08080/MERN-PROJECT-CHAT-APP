                            ...
                            <div className="avatar w-14 h-14 rounded-full bg-base-300">
                              {request.sender.ProfilePic ? (
                                ...
                                <div className="flex items-center justify-center w-full h-full text-xl font-semibold">
                                  {request.sender.fullName ? request.sender.fullName.charAt(0).toUpperCase() : '?'}
                                </div>
                              )}
                            </div>
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1.5 mt-1">
                                <span className="badge badge-secondary badge-sm">
                                  Native: {request.sender.nativeLanguage || request.sender.nativelanguage || 'Unknown'}
                                </span>
                                <span className="badge badge-outline badge-sm">
                                  Learning: {request.sender.learningLanguage || request.sender.learinglanguages || 'Unknown'}
                                </span>
                              </div>
                            </div>
                          </div>
